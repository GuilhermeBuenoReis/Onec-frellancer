...
import { useContestationDataTableContext } from '../-context/data-table-context';

export function ContestationFilterDialog() {
  const { setFilters } = useContestationDataTableContext();
  ...
  function applyFilters() {
    ...
    setTimeout(() => {
      const formatted = [
        ...
        product && { id: 'product', value: product },
        status && { id: 'status', value: status },
        competence && { id: 'competence', value: competence },
        createdAt && {
          id: 'createdAt',
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Filtrar contestações</DialogTitle>
        </DialogHeader>
