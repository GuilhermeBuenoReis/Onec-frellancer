...
import { SectionCardsNegotiation } from './components/sections-cards-negotiation';
          ...
          <div className="w-full flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <CardDescription className="text-sm sm:text-base">
                ...
                responsáveis por cada operação. Ideal para controle e tomada de
                decisão estratégica.
              </CardDescription>
            </div>
