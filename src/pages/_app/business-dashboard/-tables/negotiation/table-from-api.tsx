...
import { useNegotiationFiltersContext } from '@/pages/_app/business-dashboard/-context/negotiation-filter-context';
...
export function NegotiationTableFromAPI() {
  ...
  const filteredData: GetNegotiation200 = negotiations
    .filter(n => {
