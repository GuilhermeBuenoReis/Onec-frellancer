 ...
 * {@link /partners/:id}
 */
export function useGetOnePartnerInfinite<
  TData = InfiniteData<ResponseConfig<GetOnePartnerQueryResponse>>,
  TQueryData = ResponseConfig<GetOnePartnerQueryResponse>,
  TQueryKey extends QueryKey = GetOnePartnerInfiniteQueryKey,
>(
  ...
  const query = useInfiniteQuery(
    {
      ...getOnePartnerInfiniteQueryOptions(id, config),
      queryKey,
      ...queryOptions,
