...
type SheetSize = 'xs' | 'sm' | 'md' | 'lg' | 'xl';
const sizeClasses: Record<SheetSize, string> = {
  xs: 'sm:max-w-xs w-1/4',
  sm: 'sm:max-w-sm w-1/3',
  md: 'sm:max-w-md w-1/2',
  lg: 'sm:max-w-lg w-3/4',
...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-none">
